...
export const CHARACTERS = [
  {
    ...
    emoji: '🔥',
    image: './assets/hari.png',
    face: { skin: '#f6d7c4', hair: '#2b1a2e', accent: '#ff3d77', eyes: '#3a1b2b' },
    palette: { primary: '#ff6f91', soft: '#ffe3ea', deep: '#3a1526' },
    speed: 22,
    voice: {
      // 문장 끝에 붙는 버릇
      tics: ['.', '.', '. 진짜로.', '. 알지?'],
...
- 금지: 장황한 설명, 이모지 남발, 훈계조 마무리.`,
  ...
  },
  {
    ...
    title: '다정한 연상',
    kicker: '공 감 상 담',
    headline: '끝까지 들어주는 사람',
    age: '30',
    tagline: '많이 힘들었겠다. 천천히 말해줘, 다 들을게.',
    emoji: '🌙',
    image: './assets/doyun.png',
    face: { skin: '#f2d3ba', hair: '#1f2f4d', accent: '#5b8def', eyes: '#22324d' },
    palette: { primary: '#ffb36b', soft: '#ffeedd', deep: '#3a2416' },
    speed: 30,
    voice: {
      tics: ['.', '...', '. 그치?', '. 괜찮아.'],
